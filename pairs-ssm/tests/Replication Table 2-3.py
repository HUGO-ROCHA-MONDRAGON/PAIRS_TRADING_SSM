...
def main(data_path: str):
    ...
    all_results = []
    pairs_config = [
        ('PEP', 'KO', '2012-01-03', '2019-06-28', 'PEP-KO'),
        ('EWT', 'EWH', '2012-01-01', '2019-05-01', 'EWT-EWH'),
    ]

    for col_a, col_b, start, end, name in pairs_config:
        try:
    ...
    if all_results:
        ...
        print(f"{'Pair':<10} {'Model':<10} {'S':>3} {'Our Ret':>8} {'Paper':>8} {'Our SR':>8} {'Paper':>8}")
        print('-' * 60)
        for _, r in final.iterrows():
            ...
            if k in paper:
                ...
                print(f"{r['Pair']:<10} {r['Model']:<10} {r['Strategy']:>3} "
                      f"{r['Return']:>8.4f} {pr:>8.2f} {r['Sharpe']:>8.4f} {ps:>8.2f}")
